...
function completely(container, config) {
    ...
    var rs = { 
        ...
        repaint : function() {
            ...
            for (var i=0;i<optionsLength;i++) {
                var opt = options[i].toLowerCase();
                if (opt.indexOf(token.toLowerCase())===0) {         // <-- how about upperCase vs. lowercase
                    txtHint.value = token[0] + opt.substring(1);
                    break;
                }
            }
    ...
    **/
    ...
    var keyDownHandler = function(e) {
        ...
        if (keyCode == 39 || keyCode == 35 || keyCode == 9 || keyCode == 13) { // right,  end, tab  (autocomplete triggered)
